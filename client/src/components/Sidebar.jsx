...
const Sidebar = ({ activeRoom, onRoomChange, rooms, isMobileOpen, setIsMobileOpen }) => {
  ...
  return (
    <>
      ...
      <aside className={`glass fixed top-0 left-0 w-full md:w-72 h-full z-30 transition-transform duration-300 ${isMobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} flex flex-col overflow-hidden bg-background/95 backdrop-blur-lg border-r border-border/40`}>
        {/* Header */}
