    ...
    >
      <div className="card-3d-inner grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col justify-between">
          <div>
            <h3 className="font-display text-lg font-medium mb-2">Room Status</h3>
            <p className="text-sm text-foreground/60 mb-4">All systems operating normally</p>
            ...
            <div className="space-y-4">
              {roomData.stats.map((stat) => (
                ...
                >
                  <div className={`w-10 h-10 rounded-lg glass flex items-center justify-center text-${stat.color}`}>
                    <stat.icon size={18} />
                  </div>
                  <div className="ml-3">
